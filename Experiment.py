...
def tr_test(epsilon_start, epsilon_end, epsilon_decay, env, device, num_episodes, network_sizes, n_repetitions = 20):
...
def main():
    ...
    experiment_learning_rate(epsilon_start, epsilon_end, epsilon_decay, env, device, num_episodes, network_sizes, lr, n_repetitions)
